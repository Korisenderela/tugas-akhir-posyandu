          ...
          <div class="bg-white card shadow rounded">
            <div class="row">
              <div class="col-md-7 mt-5 mb-5 pe-0">
                <div class="form-left h-100 py-5 px-5">
                 ...
                 <form action="{{url('login-admin')}}" method="post" class="row g-4">
                  @csrf
                  <div class="col-12">
            ...
            <div class="col-md-5 ps-0 d-none d-md-block">
              <div class="form-right h-100 bg-primary text-white text-center pt-5">
                ...
                <center>
                  <img src="{{url('public/assets/logo-posyandu-putih.png')}}" width="80%" style="margin-top:70pt" alt=""> <br> <br> <br>

                  <a href="{{url('login')}}" class="btn bg-white text-primary">Masuk sebagai Orang Tua ?</a> <br>
                </center>
